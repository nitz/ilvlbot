...
namespace bnet.Requests
{
	public class Get
	{
		public static async Task<RequestResult<GuildMembers>> GuildInfo(string realm, string guild_name)
		{
			...
			return await Common.RequestAndDeserialize<GuildMembers>(req_string, CacheMode.Uncached, authenticatonHeader: Api.Token);
		}
		...
		public static async Task<RequestResult<Character>> CharacterInfo(string realm, string character, Fields.Character fields)
		{
			...
			return await Common.RequestAndDeserialize<Character>(req_string, CacheMode.Uncached, authenticatonHeader: Api.Token);
		}
		...
		public static async Task<RequestResult<CharacterClasses>> CharacterClasses()
		{
			...
			return await Common.RequestAndDeserialize<CharacterClasses>(req_string, CacheMode.Cached, authenticatonHeader: Api.Token);
		}
		...
		public static async Task<RequestResult<CharacterRaces>> CharacterRaces()
		{
			...
			return await Common.RequestAndDeserialize<CharacterRaces>(req_string, CacheMode.Cached, authenticatonHeader: Api.Token);
		}
		...
		public static async Task<RequestResult<CharacterAchievements>> Achievement(int id)
		{
			...
			return await Common.RequestAndDeserialize<CharacterAchievements>(req_string, CacheMode.Cached, authenticatonHeader: Api.Token);
		}
